...
###################################################################################    
    def first_save():
        ...
        file="/home/pi/test-repo/train_images/folderA/img_black_01"+".jpg"
    ...
    def second_save():
        image=Image.fromarray(img1)
        canny_pics=cv2.Canny(img1,100,40)
        file="/home/pi/test-repo/train_images/folderB/img_black_01"+".jpg"
        cv2.imwrite(file,canny_pics)
    ...
    def fourth_save():
        image=Image.fromarray(img1)
        canny_pics=cv2.Canny(img1,100,40)
        file="/home/pi/test-repo/train_images/folderD/img_black_01"+".jpg"
        cv2.imwrite(file,canny_pics)
...
def whenopen():
    ...
    def choosethefolder():
        ...
        #cam.release()
            ...
            file="/home/pi/test-repo/test/img00"+".jpg"
            cv2.imwrite(file,canny_pics)
